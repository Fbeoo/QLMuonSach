...
<div class="row" style="width: 80%; margin: auto; padding-top: 30px">
        <div class="col-6">
            ...
            <select name="typeReport" id="report" class="form-control custom-select">
                <option value="" selected>Lựa chọn loại báo cáo cần xuất</option>
                <option value="bookRent">Sách được mượn</option>
            </select>
        </div>
        <div class="col-6" id="time">
            <div class="form-group">
                <label>Thời gian</label>
                <input class="form-control" type="text" name="dateRangeReport" id="dateRangeReport" value=""/>
            </div>
        </div>
</div>
